...
function ProjectCard({ project }: { project: Project }) {
    ...
    const title = language === "th" ? project.titleTh : project.title;
    const description = language === "th" ? project.descriptionTh : project.description;
    const problem = language === "th" ? project.problemTh : project.problem;
    const solution = language === "th" ? project.solutionTh : project.solution;
    ...
    return (
        ...
        >
            ...
            <div className="p-6">
                ...
                >
                    {isExpanded ? t("projects.showLess") : t("projects.viewCase")}
                    <svg
