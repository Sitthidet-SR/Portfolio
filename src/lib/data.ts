...
export const projects = [
    {
        ...
        description: "A mobile task management app built with React Native featuring beautiful UI and multi-language support.",
        descriptionTh: "แอพจัดการงานบนมือถือ สร้างด้วย React Native พร้อม UI สวยงาม และรองรับหลายภาษา",
        problem: "Need an efficient mobile app to organize and track daily tasks.",
        problemTh: "ต้องการแอพมือถือที่มีประสิทธิภาพในการจัดระเบียบและติดตามงานประจำวัน",
        solution: "Built a feature-rich mobile task management app with intuitive interface.",
        solutionTh: "สร้างแอพจัดการงานบนมือถือที่มีฟีเจอร์ครบครัน พร้อม UI ที่ใช้งานง่าย",
