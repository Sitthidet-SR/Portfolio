...
export const projects = [
    ...
    },
    {
        ...
        titleTh: "แอพ To-Do List",
        description: "A clean and simple to-do list application for managing daily tasks with local storage persistence.",
        descriptionTh: "แอพจัดการ To-Do List ที่เรียบง่าย สำหรับจัดการงานประจำวัน พร้อมบันทึกข้อมูลลง Local Storage",
        ...
        solution: "Created a lightweight to-do app with intuitive UI and persistent storage.",
        solutionTh: "สร้างแอพ To-Do ที่เบาและรวดเร็ว พร้อม UI ที่ใช้งานง่ายและบันทึกข้อมูลถาวร",
