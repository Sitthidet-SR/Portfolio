...
export const projects = [
    ...
    },
    {
        ...
        titleTh: "DevShop ร้านค้าออนไลน์",
        description: "A full-featured e-commerce platform built with PHP, featuring product management, shopping cart, and payment integration.",
        descriptionTh: "แพลตฟอร์มร้านค้าออนไลน์ครบวงจร สร้างด้วย PHP รองรับจัดการสินค้า ตะกร้าสินค้า และระบบชำระเงิน",
        problem: "Small businesses need an affordable online store solution.",
        problemTh: "ธุรกิจขนาดเล็กต้องการระบบร้านค้าออนไลน์ที่ราคาไม่แพง",
        solution: "Built a complete e-commerce system with admin panel and user-friendly interface.",
        solutionTh: "สร้างระบบร้านค้าออนไลน์ครบวงจรพร้อมแผงควบคุมสำหรับผู้ดูแลและหน้าเว็บที่ใช้งานง่าย",
