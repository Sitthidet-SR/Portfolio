...
export const projects = [
    ...
    },
    {
        ...
        description: "A modern to-do list web application built with React and Vite for fast performance.",
        descriptionTh: "เว็บจัดการ To-Do List ที่ทันสมัย สร้างด้วย React และ Vite ทำงานได้รวดเร็ว",
        ...
        solution: "Created a fast and responsive to-do website using React with Vite bundler.",
        solutionTh: "สร้างเว็บ To-Do ที่เร็วและตอบสนองดี โดยใช้ React กับ Vite",
