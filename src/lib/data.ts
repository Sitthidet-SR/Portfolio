...
export const projects = [
    {
        ...
        titleTh: "แอพ TaskMaster",
        description: "A modern task management application with beautiful UI, multi-language support, and real-time updates.",
        descriptionTh: "แอพจัดการงานที่ทันสมัย พร้อม UI สวยงาม รองรับหลายภาษา และอัปเดตแบบ Real-time",
        problem: "Need an efficient way to organize and track daily tasks and projects.",
        problemTh: "ต้องการวิธีจัดระเบียบและติดตามงานประจำวันและโปรเจคอย่างมีประสิทธิภาพ",
        solution: "Built a feature-rich task management app with intuitive interface and smart features.",
        solutionTh: "สร้างแอพจัดการงานที่มีฟีเจอร์ครบครัน ใช้งานง่าย และมีฟีเจอร์อัจฉริยะ",
        techStack: ["React", "TypeScript", "Tailwind CSS", "Node.js"],
        image: "/projects/taskmaster.jpg",
        liveUrl: "#",
        githubUrl: "https://github.com/Sitthidet-SR/TaskMaster_App",
        featured: true,
    },
    {
        id: 2,
    ...
    {
        id: 3,
        title: "DevShop - Course Platform",
        titleTh: "DevShop - แพลตฟอร์มขายคอร์ส",
        description: "An online platform for selling programming courses and web development tutorials. Features course management, user enrollment, and payment system.",
        descriptionTh: "แพลตฟอร์มออนไลน์สำหรับขายคอร์สเรียนเขียนโปรแกรมและสอนพัฒนาเว็บ รองรับจัดการคอร์ส การลงทะเบียน และระบบชำระเงิน",
        problem: "Developers and instructors need a platform to sell programming courses online.",
        problemTh: "นักพัฒนาและผู้สอนต้องการแพลตฟอร์มสำหรับขายคอร์สเรียนเขียนโปรแกรมออนไลน์",
        solution: "Built a complete course selling platform with admin panel, course player, and payment integration.",
        solutionTh: "สร้างแพลตฟอร์มขายคอร์สครบวงจร พร้อมแผงควบคุม ระบบเล่นคอร์ส และระบบชำระเงิน",
        techStack: ["PHP", "MySQL", "HTML", "CSS", "JavaScript"],
        image: "/projects/devshop.jpg",
        liveUrl: "#",
        githubUrl: "https://github.com/Sitthidet-SR/devshop-php",
        featured: true,
    },
    {
        id: 4,
        title: "To-Do List Website",
        titleTh: "เว็บ To-Do List",
        description: "A clean and simple to-do list website for managing daily tasks with local storage persistence.",
        descriptionTh: "เว็บจัดการ To-Do List ที่เรียบง่าย สำหรับจัดการงานประจำวัน พร้อมบันทึกข้อมูลลง Local Storage",
        problem: "Need a simple way to track and organize daily tasks.",
        problemTh: "ต้องการวิธีง่ายๆ ในการติดตามและจัดระเบียบงานประจำวัน",
        solution: "Created a lightweight to-do website with intuitive UI and persistent storage.",
        solutionTh: "สร้างเว็บ To-Do ที่เบาและรวดเร็ว พร้อม UI ที่ใช้งานง่ายและบันทึกข้อมูลถาวร",
        techStack: ["JavaScript", "HTML", "CSS", "LocalStorage"],
        image: "/projects/todolist.jpg",
        liveUrl: "#",
        githubUrl: "https://github.com/Sitthidet-SR/to-do-list",
        featured: false,
    },
    {
        id: 5,
